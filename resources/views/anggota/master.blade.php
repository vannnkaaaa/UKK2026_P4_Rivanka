        ...
        <div class="left side-menu">
            ...
            <div class="topbar-left">
                <div class="text-center">
                    <a href="{{ route('anggota.dashboard') }}" class="logo">
            ...
            <div class="sidebar-inner slimscrollleft">
                <div id="sidebar-menu">
                    <ul>
                        <li class="menu-title">Menu Anggota</li>
                            ...
                            <li class="list-inline-item dropdown notification-list">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-menu-lg">
                                    ...
                                    <a href="" class="dropdown-item notify-item">
                                        <div class="notify-icon bg-info"><i class="mdi mdi-information"></i></div>
                                        <p class="notify-details"><b>Status Peminjaman</b>
                                            <small class="text-muted">Cek status peminjaman kamu</small>
                                        </p>
                                    </a>
                                </div>
                            </li>
